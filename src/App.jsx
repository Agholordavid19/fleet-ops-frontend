            ...
            <Routes>
                ...
                <Route element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
                    ...
                    <Route path="/admin/users"
                           element={<ProtectedRoute allowedRoles={['ADMIN']}><UsersScreen /></ProtectedRoute>}
                    />
                    <Route path="/admin/reports"
                           element={<ProtectedRoute allowedRoles={['ADMIN']}><ReportsScreen /></ProtectedRoute>}
                    />

                    {/* Fleet Manager + Admin */}
                    <Route path="/fleet/vehicles"
                           element={<ProtectedRoute allowedRoles={['FLEET_MANAGER', 'ADMIN']}><VehiclesScreen /></ProtectedRoute>}
                    />
                    <Route path="/fleet/maintenance"
                           element={<ProtectedRoute allowedRoles={['FLEET_MANAGER', 'ADMIN']}><MaintenanceScreen /></ProtectedRoute>}
                    />
                    <Route path="/fleet/trips"
                           element={<ProtectedRoute allowedRoles={['FLEET_MANAGER', 'ADMIN']}><TripManagementScreen /></ProtectedRoute>}
                    />
                    <Route
                    ...
                    {/* Field Staff */}
                    <Route path="/staff/trips"
                           element={<ProtectedRoute allowedRoles={['FIELD_STAFF']}><TripsScreen /></ProtectedRoute>}
                    />
                    <Route path="/staff/mileage"
                           element={<ProtectedRoute allowedRoles={['FIELD_STAFF']}><MileageScreen /></ProtectedRoute>}
                    />
                    <Route
                    ...
                    {/* Maintenance */}
                    <Route path="/maintenance/flags"
                           element={<ProtectedRoute allowedRoles={['MAINTENANCE']}><FlagsScreen /></ProtectedRoute>}
                    />
