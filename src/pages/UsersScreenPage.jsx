...
import { useGetUsersQuery, useCreateUserMutation } from '../apis/fleetApi'
...
const emptyForm = { name: '', email: '', password: '', role: 'FIELD_STAFF' }
            ...
            <Modal open={open} onClose={() => setOpen(false)} title="Create New User">
                <form onSubmit={handleSubmit}>
                    ...
                    <FormField label="Email">
                        <Input type="email" name="email" placeholder="jane@fleet.com" value={form.email} onChange={handleChange} required />
                    </FormField>
                    ...
                    <SubmitButton loading={creating}>Create User</SubmitButton>
                </form>
            </Modal>
        </>
    )
